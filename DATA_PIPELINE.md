...
This document explains the design of the data pipeline which import (optionally transform) price data into the database.
...
#### 2 Data transformation Lambda trigger & 3 Fargate task running the transformation
...
#### 5 Lambda function which runs the data loader Fargate task
